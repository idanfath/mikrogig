...
final class CancelGig
{
    ...
    public function execute(User $client, Gig $gig): Gig
    {
        ...
        $this->realtime->stateChanged($cancelledGig, GigRealtimeChange::Gig, $freelancerIds);
        if ($wasDiscoverable) {
            $this->realtime->discoveryChanged($cancelledGig, GigDiscoveryChange::Remove);
        }
