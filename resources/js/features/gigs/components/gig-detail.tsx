            ...
            <div className="flex flex-col gap-6">
                <AppPageCard className="flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-xs sm:grid-cols-2">
                        ...
                        {isAcceptedWorker && gig.location_latitude && isAccurate && (
                            <div className="flex flex-col gap-3 rounded-xl border border-border/40 bg-secondary/40 p-3.5 sm:col-span-2">
                                <div className="flex flex-wrap items-center justify-between gap-3">
                                    ...
                                    >
                                        <a
                                            href={`https://www.google.com/maps/place/${gig.location_latitude},${gig.location_longitude}`}
                                            target="_blank"
                                ...
                                {!distanceLoading && distanceFormatted && (
                        ...
                        <form onSubmit={submit} className="flex flex-col gap-3">
                            ...
                            {isWithdrawn && (
                                <p className="text-xs text-muted-foreground">
                                    Penawaran sebelumnya telah dibatalkan ({getGigOfferStatusLabel(myOffer?.status)}) .
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <InputGroup mobileLarge>
                                    ...
                                    <InputGroupInput
                                        type="number"
                                        min="1000"
                                        placeholder={gig.posted_fee.toLocaleString('id-ID') + ' (opsional)'}
                ...
                {myOffer && !isWithdrawn && (
                    <AppPageCard className="flex flex-col gap-4">
                        <div
                            className={`flex flex-wrap items-center justify-between gap-3 ${myOffer.note || myOffer.status === GigOfferStatus.PENDING
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        confirm({
                                            ...
                                            description: 'Penawaran Anda pada gig ini akan ditarik.',
                                            confirmLabel: 'Ya, tarik',
                                            destructive: true,
                                            onConfirm: () => form.patch(withdraw.url(myOffer)),
                                        })
                                    }
                                >
                                    Tarik penawaran
