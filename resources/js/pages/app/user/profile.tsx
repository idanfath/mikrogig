...
import { AvatarActions } from '@/components/profile/avatar-actions';
import { BasicFields } from '@/components/profile/basic-fields';
import { FreelancerFields } from '@/components/profile/freelancer-fields';
...
const ProfilePage: InertiaPageWithLayout<ProfilePageProps> = ({
  profile,
  is_owner,
  has_custom_avatar,
  max_date_of_birth,
