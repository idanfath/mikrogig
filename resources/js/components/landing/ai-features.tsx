...
const defaultFeatures: AIFeature[] = [
  {
    ...
    visual: (
      <div
        className="flex h-16 items-center gap-1 rounded-2xl border border-primary/15 bg-white/70 px-4"
        aria-hidden="true"
      >
        <span className="mr-2 grid size-8 place-items-center rounded-full bg-primary text-white">
  ...
  },
  {
    ...
    tone: 'default',
    visual: (
      <div className="rounded-xl bg-secondary p-3 px-4 text-xs leading-5 text-muted-foreground">
