            ...
            <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
                <Card variant="dark" padding="lg" className="overflow-hidden">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        ...
                        <span className="rounded-full border border-white/10 px-3 py-1 text-[10px] font-bold tracking-[0.08em] text-white/45 uppercase">
                    ...
                    <div className="mt-8 grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <select
                                ...
                                value={job}
                                onChange={(event) =>
                                    setJob(event.target.value as JobKey)
                                }
                                className="mt-2 h-12 w-full rounded-xl border border-white/12 bg-white/8 px-3 text-sm font-semibold text-white outline-none focus:border-brand focus:ring-3 focus:ring-brand/20"
                            >
                    ...
                    <div className="mt-7 rounded-2xl border border-white/10 bg-white/7 p-5">
                        ...
                        <p className="mt-2 text-3xl font-extrabold tracking-[-0.05em] text-white sm:text-4xl">
