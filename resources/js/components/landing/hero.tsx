...
function Hero({
    ...
    title = (
        <>
            Kerja dekat rumah. <span className="text-primary">Upah jelas.</span>{' '}
    ...
    return (
        <section
            ...
            {...props}
        >
            <div className="landing-grid pointer-events-none absolute inset-x-0 top-0 -z-20 h-[44rem] opacity-70" />
            <div className="pointer-events-none absolute top-8 left-[62%] -z-10 size-[28rem] rounded-full bg-brand/12 blur-3xl" />
...
function ProductPreview() {
    return (
        <div className="relative mx-auto w-full max-w-[35rem] lg:ml-auto">
            <div className="absolute -inset-5 -z-10 rounded-[2.4rem] bg-brand-soft/75 blur-2xl" />
            <div className="shadow-soft rounded-[2rem] border border-white/70 bg-white/55 p-2.5 backdrop-blur-sm sm:p-3">
                <Card
                    variant="elevated"
                    padding="none"
