...
function Categories({
    ...
    return (
        ...
        >
            ...
            <div className="mt-5 flex flex-col gap-3 rounded-2xl border border-dashed border-brand/30 bg-brand-soft/35 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
